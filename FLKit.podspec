#
#  Be sure to run `pod spec lint FLKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of FLKit in Markdown format.
  ...
  # s.authors      = { "wufulin" => "wufulinit@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'wufulin', 'other author'
